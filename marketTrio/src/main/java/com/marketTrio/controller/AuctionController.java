...
private AuctionService auctionService;
    ...
    public String viewAuction(HttpServletRequest request,
            @PathVariable("auctionId") int auctionId, Model model) {
    ...
    public String deleteAuction(@PathVariable("auctionId") int auctionId) {
        ...
        if (check == 0) {return "redirect:/auction/list"; }
        return "redirect:/auction/list";
    }
    ...
    public String placeBid(@PathVariable("auctionId") int auctionId, @ModelAttribute int price, Model model) {
    	...
    	if(isbid == 0) {return  "redirect:/posts/detail/{auctionId}";}
    	else {return "redirect:/posts/detail/{auctionId}";}
    }
}