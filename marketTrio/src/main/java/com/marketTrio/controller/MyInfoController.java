...
//        String memberId = memberSession.getMemberId();
	...
	public String showMyInfo(HttpServletRequest request, Model model, SessionStatus status) {
...
//	@ModelAttribute("memberCommand")
    ...
    public String showForm(@RequestParam("password") String password,
                           @ModelAttribute("memberCommand") MemberCommand memberCommand, Model model) throws Exception {
        try {
